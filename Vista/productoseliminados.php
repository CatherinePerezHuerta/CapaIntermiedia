...
$sql_productos = "SELECT * FROM productos WHERE aprobado = -1 AND id_vendedor = ?";
...
<section class="pagina">
    ...
    <main>
            ...
            <div class="container">
                ...
                <div class="panel">
                    <h2>Mis Publicaciones No Aprobadas</h2>
                    <?php if ($result_productos->num_rows > 0): ?>
                        <?php while ($producto = $result_productos->fetch_assoc()): ?>
                            <div class="item">
                                ...
                                <!-- Botones de acción -->
                                <div class="acciones">
                                    <form action="../Controlador/producto_eliminado.php" method="post">
                                        <input type="hidden" name="id_producto" value="<?php echo $producto['id_producto']; ?>">
                                        <button type="submit" name="accion" value="esconder" class="reject">Mandar</button>
